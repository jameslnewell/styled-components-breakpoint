...
import breakpoint, { map } from './index';
...
describe('breakpoint()', () => {
  ...
  it('should have styles defined for each default breakpoint', () => {
    ...
    expect(element).toHaveStyleRule('font-size', '16px', { media: '(min-width:46.0625em)' });
    expect(element).toHaveStyleRule('font-size', '24px', { media: '(min-width:64.0625em)' });
  });
...
`;
  ...
  it('should have styles defined for each default breakpoint', () => {
    const element = shallow(<Thing size={{ mobile: 1, tablet: 1 / 2, desktop: 1 / 4 }} />);
    expect(element).toHaveStyleRule('width', '100%');
    expect(element).toHaveStyleRule('width', '50%', { media: '(min-width:46.0625em)' });
    expect(element).toHaveStyleRule('width', '25%', { media: '(min-width:64.0625em)' });
  });
  ...
  it('should have styles defined for each custom breakpoint', () => {
    ...
    expect(element).toHaveStyleRule('width', '100%', { media: '(min-width:20em)' });
    expect(element).toHaveStyleRule('width', '50%', { media: '(min-width:60em)' });
    expect(element).toHaveStyleRule('width', '25%', { media: '(min-width:180em)' });
  });
